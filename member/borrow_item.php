                ...
                <div class="x_panel">
					...
					<div class="row" style="margin-top:30px;">
						...
						<th class="text-center">Action</th>
							...
							<img src="../admin/upload/<?php echo $item_row['item_image']; ?>" width="120px" height="120px" style="border:4px groove #CCCCCC; border-radius:5px;">
							<?php else: ?>
							<img src="/admin/images/item_image.jpg" width="120px" height="120px" style="border:4px groove #CCCCCC; border-radius:5px;">
							<?php endif; ?>
							</td> 
						...
						<div class="table-responsive">
							...
							<tr style="height:120px">
								<td>
									...
									<img src="../admin/upload/<?php echo $borrow_row['item_image']; ?>" width="120px" height="120px" style="border:4px groove #CCCCCC; border-radius:5px;">
									<?php else: ?>
									<img src="../admin/images/item_image.jpg" width="120px" height="120px" style="border:4px groove #CCCCCC; border-radius:5px;">
									<?php endif; ?>
								</td> 
