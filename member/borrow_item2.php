						...
						<!--	<th>Barcode</th> -->
							...
							<?php 
								if (isset($_POST['item_name'])){
									...
									if ($item_row['item_name'] == ''){
										echo '
											<table>
												<tr>
													<td class="alert alert-info">No match for the apparatus entered!</td>
												</tr>
											</table>
										';
									} elseif ($item_name == '') {
							...
							<img src="upload/<?php echo $item_row['item_image']; ?>" width="100px" height="100px" style="border:4px groove #CCCCCC; border-radius:5px;">
							<?php else: ?>
							<img src="images/item_image.png" width="150px" height="180px" style="border:4px groove #CCCCCC; border-radius:5px;">
							<?php endif; ?>
							</td> 
							...
							<td style="text-align:center; vertical-align:middle"><?php echo $item_row['category_id'] ?></td>
							...
							<td><td style="text-align:center; vertical-align:middle"><?php echo $item_row['status'] ?></td>
							...
							<?php 
								if (isset($_POST['borrow'])){
									...
									if ($new_quantity < 0){
										...
										echo "<script>alert('Apparatus needs to be replaced!'); window.location='borrow_item.php?school_number=".$school_number."'</script>";
									...
									mysqli_query($con,"INSERT INTO borrow_item(user_id,item_id,date_borrowed,due_date,borrowed_status)
									VALUES('$user_id','$item_id','$date_borrowed','$due_date','borrowed')") or die (mysqli_error());
								...
								//	VALUES ('$item_id','$user_id','$admin_row','Borrowed Item',NOW())") or die(mysqli_error());
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<tr>
								...
								<img src="upload/<?php echo $borrow_row['item_image']; ?>" width="100px" height="100px" style="border:4px groove #CCCCCC; border-radius:5px;">
								<?php else: ?>
								<img src="../admin/images/item_image.png" width="150px" height="180px" style="border:4px groove #CCCCCC; border-radius:5px;">
								<?php endif; ?>
								</td> 
						
								<td style="text-transform: capitalize"><?php echo $borrow_row['property_no']; ?></td>
								<td style="text-transform: capitalize"><?php echo $borrow_row['item_name']; ?></td>
								<td style="text-transform: capitalize"><?php echo $borrow_row['category_id']; ?></td>
								<td style="text-transform: capitalize"><?php echo $borrow_row['specification']; ?></td>
