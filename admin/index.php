        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <section class="login_content">
                    ...
                    <h1 style="color:white;text-shadow: none;">Admin Login</h1>
                        <div>
                        ...
                        <div class="separator">
                        <a style="color:white;" href="/labsys/member/"> Login as Member</a> 
                            <div class="clearfix"></div>
                                <br />
                                <br />
                                <br />
                                ...
                                <br />
                            <div>
                              <!-- <h1><i class="" style="font-size: 26px;"></i> Cagayan de Oro National High School-Junior High</h1>  <h1><i class="" style="font-size: 22px;"></i> Cagayan de Oro National High School- Junior High</h1> -->

                                <p>© <?php echo date('Y'); ?> <i class=""></i> Laboratory Information Management System for Cagayan de Oro National High School- Junior High</p>
                            </div>
                        </div>
                    </form>
<?php
