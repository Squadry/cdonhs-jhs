...
?>
					...
					?>
							...
							<button class="btn btn-primary btn-outline pull-right"><i class="fa fa-plus"></i> Add Admin</button>
							</a>
							</li>
					<?php } ?>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<td style="text-align:center; vertical-align:middle">
									...
									<a class="btn btn-danger" for="DeleteAdmin" href="delete_admin.php<?php echo $id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
									...
									<div class="modal-dialog">
										...
										<div class="modal-header">
											<h4 class="modal-title pull-left" id="myModalLabel"><i class="glyphicon glyphicon-user"></i> Admin</h4>
											<br/>
										</div>
