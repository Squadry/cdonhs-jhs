...
<body>
	<div class = "container">
		...
		<br/>
				...
				<strong><center><h4 style =margin-top:-16px;></h4> Borrowed Apparatus Report Sheet</center> </strong>
...
<?php
							...
							where borrow_item.borrowed_status = 'borrowed'  order by borrow_item.borrow_item_id DESC") or die (mysqli_error());
...
?>
							<tr>
								...
								<td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['item_name']; ?></td>
								<td style="text-align:center;"><?php echo date("M d, Y h:m:s a",strtotime($return_row['date_borrowed'])); ?></td>
								<td style="text-align:center;"><?php echo date("M d, Y h:m:s a",strtotime($return_row['due_date'])); ?></td>
								
								<td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['contact']; ?></td>
