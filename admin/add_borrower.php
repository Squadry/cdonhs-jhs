<?php include ('header.php'); ?>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                    <h2><i class="fa fa-plus"></i> Add Borrower</h2>
                        ...
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name">School ID No. <span class="required" style="color:red;">*</span>
                                    </label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="middlename" id="first-name2" class="form-control col-md-7 col-xs-12" placeholder="**optional">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="last-name">Contact No. <span class="required" style="color:red;">*</span>
                                    </label>
                                    <div class="col-md-4">
                                        <input type="tel" pattern="[0-9]{11,11}" autocomplete="off"  required="required" maxlength="11" name="contact" id="last-name2" placeholder="e.g (09) 1234 56789"class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-4">
                                        <select name="department" class="select2_single form-control" required="required" tabindex="-1" >
                                            <option value="Science">Science</option>
                                        </select>
                                    </div>
                                </div>							
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="h_address">Address <span class="required" style="color:red;">*</span>
                                    </label>
                                    <div class="col-md-4">
                                        <textarea name="h_address" id="h_address" required="required" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                        <!---        <div class="form-group">
		...
		//							$profile=$_FILES["image"]["name"];
					...
					if ($row > 0)
					{
					echo "<script>alert('ID Number already active!'); window.location='borrower.php'</script>";
					}
                    elseif($password != $confirm_password)
					{
					echo "<script>alert('Password do not match!'); window.location='add_borrower.php'</script>";
                    }
					else
					{		
						mysqli_query($con,"insert into user (school_number,firstname, middlename, lastname, contact, gender, h_address, department, password, confirm_password, status, user_added)
						values ('$school_number','$firstname', '$middlename', '$lastname', '$contact', '$gender', '$h_address', '$department', '$password', '$confirm_password', '$status', NOW())")or die(mysqli_error());
						echo "<script>alert('Borrower successfully added!'); window.location='borrower.php'</script>";
					}
			//						}
			//						}
							}
