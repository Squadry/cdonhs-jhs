        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							...
							<a href="book_print_old.php" target="_blank" style="background:none;">
							<a href="export_excel_old.php" target="_blank" style="background:none;">
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation"><a href="inventory_old.php">New Apparatus</a></li>
								<li role="presentation" class="active"><a href="inventory_old.php">Old Apparatus</a></li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<?php
							$result= mysqli_query($con,"select * from item where status = 'old' ") or die (mysqli_error());
