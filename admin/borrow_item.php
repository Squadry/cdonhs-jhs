                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<tr style="height:120px">
								...
								<td style="text-align:center; vertical-align:middle"><?php echo date("M d, Y h:m:s a",strtotime($borrow_row['date_borrowed'])); ?></td>			
										...
										<?php elseif($borrow_row['r_status'] == 1): ?>
											<td style="text-align:center; vertical-align:middle"><span class="badge bg-green">Approved</span></td>
										...
										<?php elseif($borrow_row['r_status'] == 3): ?>
											<td style="text-align:center; vertical-align:middle"><span class="badge bg-red">Denied</span></td>
								...
								<form method="post" action="">
									...
									<form method="post" action="">
										<button name="edit" for="EditStatus" href="#r_status" data-toggle="modal" data-target="#r_status" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i>Edit Status</button>
									</form>
							...
							?>
								...
								<div class="modal fade" id="r_status<?php  echo $borrow_item_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-plus"></i> Update Borrowed Apparatus Status</h4>
										</div>
										<div class="modal-body">
											<form method="post" enctype="multipart/form-data" class="form-horizontal">
												
												<div class="form-group" >
													<label class="control-label col-md-1" for="r_status">Status </label>
													<div class="col-md-11">
														<select class="form-control" name="r_status">
															<option value="0" <?php echo $r_status == 0 ? "selected" : '' ?>>For Approval</option>
															<option value="1" <?php echo $r_status == 1 ? "selected" : '' ?>>Approved</option>
															<option value="2" <?php echo $r_status == 2 ? "selected" : '' ?>>Claimed</option>
															<option value="3" <?php echo $r_status == 3 ? "selected" : '' ?>>Denied</option>
														</select>
													</div>
												</div>
												<div class="modal-footer" style="margin-top:50px;">
													<div class="col-md-9 col-sm-9 col-xs-10 col-md-offset-0">
														<button type="update" name="update" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i>Save</button>
											...
											<?php
												...
												{
													mysqli_query($con," UPDATE borrow_item SET r_status ='$r_status' WHERE borrow_item_id='$r_status'") or die (mysqli_error());
												}
												{
													echo "<script>
