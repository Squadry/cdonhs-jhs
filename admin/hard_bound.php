                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation"><a href="inventory_new.php">New Books</a></li>
								<li role="presentation"><a href="inventory_old.php">Old Books</a></li>
								<li role="presentation"><a href="inventory_lost.php">Lost Books</a></li>
								<li role="presentation"><a href="inventory_damaged.php">Damage Books</a></li>
								<li role="presentation"><a href="inventory_replacement.php">Subject for Replacement Books</a></li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							<tr>
								...
								<img src="upload/<?php echo $row['item_image']; ?>" class="img-thumbnail" width="75px" height="50px">
								<?php else: ?>
								<img src="images/item_image.png" class="img-thumbnail" width="75px" height="50px">
								<?php endif; ?>
								...
								<td>
									...
									<a class="btn btn-warning" for="ViewAdmin" href="edit_item.php<?php echo '?book_id='.$id; ?>">
							 ...
							 delete modal user -->
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												...
												<a href="delete_borrower.php<?php echo '?book_id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
												</div>
										</div>
										</div>
									</div>
