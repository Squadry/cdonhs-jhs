                ...
                <div class="x_panel">
					...
					<div class="row" style="margin-top:30px;">
						...
						<th class="text-center">Action</th>
							...
							<?php else: ?>
							<img src="images/item_image.png" width="120px" height="120px" style="border:4px groove #CCCCCC; border-radius:5px;">
							<?php endif; ?>
							</td> 
							...
							<?php 
								if (isset($_POST['borrow'])){
									...
									if ($countBorrowed['items_allowed'] == $allowed['qntty_items']){
										echo "<script>alert(' ".$allowed['qntty_items']." ".'apparatus allowed per borrower!'." '); window.location='borrow_item1.php?school_number=".$school_number."'</script>";
									}elseif ($itemCount['item_count'] == 10){
										echo "<script>alert('Apparatus already borrowed!'); window.location='borrow_item1.php?school_number=".$school_number."'</script>";
									}else{
									...
									if ($new_quantity < 0){
										echo "<script>alert('Apparatus out of stock!'); window.location='borrow1_item.php?school_number=".$school_number."'</script>";
									}elseif ($quantity_row['status'] == 'Damaged'){
										echo "<script>alert('Apparatus is damaged!'); window.location='borrow1_item.php?school_number=".$school_number."'</script>";
									}elseif ($quantity_row['status'] == 'Replacement'){
										echo "<script>alert('Apparatus needs to be replaced!'); window.location='borrow1_item.php?school_number=".$school_number."'</script>";
									}elseif ($quantity_row['status'] == 'Lost'){
										echo "<script>alert('Apparatus is lost!'); window.location='borrow_item1.php?school_number=".$school_number."'</script>";
									}else{
							...
							?>
									<script>
										window.location="borrow_item1.php?school_number=<?php echo $school_number ?>";
									</script>
							<?php	
								}
							?>
