<?php include ('header.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small>Home /</small> Borrowed Items
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-book"></i> Borrowed Items Monitoring</h2>
					...
					?>
							<a href="borrowed_items.php"><button class="btn btn-primary"><i class="fa fa-reply"></i> All Reports <?php // echo $count_penalty['total']; ?></button></a>
    ...
    ?>
    	...
    	$dateto = $_POST['dateto'];
							...
							<tr>
								...
								<td style="text-transform: capitalize"><a href="borrow_item.php?school_number=<?php echo $borrow_row['school_number']; ?>"><?php echo $borrow_row['firstname']." ".$borrow_row['lastname']; ?></a></td>
