            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
					<!--<button class="btn btn-danger btn-outline pull-right"><i class="fa fa-print"></i> Print Apparatus List</button>
							...
							<a href="export_excel_subrep.php" target="_blank" style="background:none;">
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a href="inventory_replacement.php">Subject for Replacement Apparatus</a></li>
							</ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
